...
class Result {
		...
		/* Complete the 'longestVowelSubsequence' function below. The function is expected to return an INTEGER.
	...
	private static void updateRunningLongestSubMap(String longestSub, char currChar, Map<Character, String> runningLongestSubMap) {
